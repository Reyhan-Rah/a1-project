...
export const CarDetails = () => {
  ...
  return (
    <div className="flex flex-col flex-1 bg-white shadow-md dark:bg-gray-800">
      <img
        className="h-96 w-full object-contain bg-light-gray "
      ...
      <div className=" md:flex md:justify-between mt-8 mx-8 md:mx-12 lg:mx-24">
        ...
        <div className="px-2 py-8 md:p-8 max-w-sm bg-white mx-auto md:mx-8 mt-8 md:mt-0 border border-gray-200 shadow-md dark:bg-gray-800 dark:border-dark-gray">
          <p className="mb-3 font-normal text-dark-gray dark:text-gray-400">
